...
import alertBanner from "@/assets/alert-banner.png";
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        <div className="mb-8 max-w-4xl mx-auto" data-aos="fade-down">
          <img 
            src={alertBanner} 
            alt="Alerte - Révélations exclusives sur les pratiques de la clinique LEMA" 
