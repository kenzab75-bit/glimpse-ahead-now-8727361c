  ...
  const timelineSteps: TimelineStep[] = [
    ...
    },
    {
      ...
      sources: [
        ...
        { label: "Enregistrement audio", info: "Discussion avec le 'dentiste'" }
      ]
    },
    {
      number: 3,
      title: "L'acte destructeur",
      description: "Installées dans le fauteuil, le profit prime sur la santé. Les soins sont réalisés au détriment de votre santé : dents saines taillées inutilement, douleurs, infections, fractures, atteintes irréversibles à votre intégrité bucco-dentaire.",
      details: [
