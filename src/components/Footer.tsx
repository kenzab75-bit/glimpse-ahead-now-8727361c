      ...
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="glass-premium p-6 rounded-2xl border-2 border-[#D7263D]/20 hover:border-[#D7263D]/40 transition-all duration-300 hover:shadow-[0_0_30px_rgba(215,38,61,0.3)]">
              <h3 className="text-base font-bold mb-4 text-foreground flex items-center gap-2">
                <MessageSquare className="h-5 w-5 text-[#D7263D]" />
                Nous contacter
              </h3>
              <div className="flex flex-col gap-4">
                <a
                  href="#contact"
                  className="flex items-center gap-3 text-sm text-muted-foreground hover:text-[#D7263D] transition-colors group"
                >
                  <div className="w-8 h-8 rounded-full bg-[#D7263D]/10 flex items-center justify-center group-hover:bg-[#D7263D]/20 transition-colors">
                    <Mail className="h-4 w-4 text-[#D7263D]" />
                  </div>
                ...
                >
                  <div className="w-8 h-8 rounded-full bg-[#D7263D]/10 flex items-center justify-center group-hover:bg-[#D7263D]/20 transition-colors">
                    <Phone className="h-4 w-4 text-[#D7263D]" />
                  </div>
